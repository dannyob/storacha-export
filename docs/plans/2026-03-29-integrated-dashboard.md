...
### Task 6: Test manually on production

- [ ] **Step 1: Push all files to production**
- [ ] **Step 2: Restart export with `--serve 0.0.0.0:8087 --html-out /store/fastphils/www/storacha-export.html`**
- [ ] **Step 3: Verify dashboard at `http://production:8087` and `https://fastphils.org/storacha-export.html`**
